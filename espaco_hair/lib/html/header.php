        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown" style="padding-top:15px;">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="text-white nav-link" href="servicos.php">Serviços</a>
              </li>
              <li class="nav-item">
                <a class="text-white nav-link" href="contato.php">Contato</a>
              </li>
              <li class="nav-item">
                <a class="text-white nav-link" href="quemSomos.php">Quem somos nós?</a>
              </li>
              <li class="nav-item">
